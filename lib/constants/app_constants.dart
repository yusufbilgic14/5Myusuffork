...
class AppConstants {
  ...
  static const Color primaryColor = Color(0xFF1E3A8A); // Navy blue - AppThemes ile tutarlılık için / For consistency with AppThemes
...
class AppMessages {
  ...
  static const String feedbackSubmitted = 'Geri bildiriminiz başarıyla gönderildi! Teşekkür ederiz.';
}
