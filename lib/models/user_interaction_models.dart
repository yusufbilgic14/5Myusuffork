...
class EventComment {
  ...
  factory EventComment.fromFirestoreData(Map<String, dynamic> data, String documentId) {
  ...
  @override
  String toString() => 'EventComment{commentId: $commentId, content: ${content.length > 50 ? '${content.substring(0, 50)}...' : content}}';

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is EventComment && runtimeType == other.runtimeType && commentId == other.commentId;
...
class CommentLike {
  ...
  /// Create from Firestore data
  factory CommentLike.fromFirestoreData(Map<String, dynamic> data, String documentId) {
    final jsonData = Map<String, dynamic>.from(data);
  ...
  @override
  String toString() => 'CommentLike{commentId: $commentId, userId: $userId, userName: $userName}';
...
class UserFollowedClub {
  ...
  factory UserFollowedClub.fromJson(Map<String, dynamic> json) => _$UserFollowedClubFromJson(json);
  Map<String, dynamic> toJson() => _$UserFollowedClubToJson(this);

  /// Create from Firestore data
  factory UserFollowedClub.fromFirestoreData(Map<String, dynamic> data, String documentId) {
    final jsonData = Map<String, dynamic>.from(data);
    ...
    // Convert Timestamps to DateTime strings
    _convertTimestampFields(jsonData, ['followedAt', 'lastEventDate', 'createdAt', 'updatedAt']);
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is UserFollowedClub && runtimeType == other.runtimeType && clubId == other.clubId;
...
class Club {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Club && runtimeType == other.runtimeType && clubId == other.clubId;
...
class ClubColors {
  ...
  factory ClubColors.fromJson(Map<String, dynamic> json) => _$ClubColorsFromJson(json);
